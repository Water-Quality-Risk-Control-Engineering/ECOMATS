...
class BaseAgent:
    """ Base agent class that provides general agent creation functionality"""
    
    # Default iteration limit to prevent excessive tool calls
    DEFAULT_MAX_ITER = 10
    ...
    def create_agent(self):
        ...
        try:
            ...
            # Standard mode: create independent LLM if temperature specified
        ...
        # Load prompt and add Memory-first guidance
        backstory = load_prompt(self.prompt_file)
        
        # Parameterized replacement support
